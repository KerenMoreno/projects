...
class StoreDetailPage extends StatefulWidget {
  ...
  const StoreDetailPage({Key? key, required this.img}) : super(key: key);
  @override
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            Text(
              "\$15.00 para retirar com \$0.00 de taxa de entrega",
              style: TextStyle(
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  const Text(
                    "Starbucks (Localizado na Avenida Beekman)",
                  ...
                  Row(
                    children: [
                      SizedBox(
                        width: size.width - 30,
                        child: const Text(
                          "Café - Coffee & Tea - Café da Manhã e Almoço - Padaria \$",
                      ...
                      SizedBox(
                        ...
                        child: Row(
                          children: [
                            ...
                            const Text(
                              "Localizado na Avenida Nova Iorque, 38",
                          ...
                          Row(
                            ...
                            children: [
                              SizedBox(
                                ...
                                child: const Text(
                                  "Não há entregadores suficientes nas proximidades, então a taxa de entrega é maior agora.",
